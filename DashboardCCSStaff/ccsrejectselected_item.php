...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($itemIds as $itemId) {
        ...
        $queryUpdateItemStatus = "UPDATE tblborrowingreports SET itemreqstatus = 'Rejected', rejectedbyid = ?, datimerejected = ?  WHERE id = ? AND itemreqstatus = 'Pending Reserve'";
