...
echo '<h3 class="text-start"><i class="fas fa-tachometer-alt me-2"></i>Current Approved Reservation</h3>';
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            $query_items = "SELECT DISTINCT b.id, b.itemid, i.itembrand, i.categoryname, i.subcategoryname, i.modelno, i.serialno, b.approvebyid, b.datetimereserve
                            ...
                            WHERE b.borrowerid = ? AND b.itemreqstatus = 'Approve Reserve'";
    ...
    function cancelRequest(itemId) {
        $.ajax({
            ...
            success: function (response) {
                ...
                window.location.href = 'borrowerAcceptedReserve.php?msg_success=Reserve item Successfully Canceled';
            }
        });
    }
</script>