        ...
        <div class="container mt-1">
            <div class="row">
                <div class="col-md-9"> <!-- Left side -->
                    <div class="row mb-1">
                        <div class="col-md-12">
                            <h3 class="text-start"><i class="fas fa-tachometer-alt me-2"></i>Confirmation of Reservation
                                Request</h3>
                            <div class="text-end">
                    ...
                    <h6 class="text-danger">Note: Any deformation or lost/damage of items borrowed are subject to
                        replacement on your account.</h6>
                ...
                <div class="col-md-3"> <!-- Right side -->
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="dateOfUse" class="form-label">Date of Use<span
                                        class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="dateOfUse" name="dateOfUse" required>
                            </div>
                            <div class="mb-3">
                                <label for="timeOfUse" class="form-label">Time of Use<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="d-grid gap-2">
                                <a href="borrowerDashboardPage.php" class="btn btn-danger">Cancel</a>
                                <button type="submit" class="btn btn-success" name="requestReserve">Confirm
                                    Request</button>
                            </div>
                        </div>
                    </div>
